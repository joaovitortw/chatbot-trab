...
def get_f1_calendar(year: int = None) -> list:
    ...
    try:
        ...
        # Remove sessões duplicadas (FP1, FP2, etc), mantendo apenas as 'Race'
...
def get_next_event_f1() -> dict:
    ...
    try:
        ...
        # DEBUG: Mostra o que está vindo da API
        print("\n--- CALENDÁRIO OPENF1 ---")
        for r in calendar:
            print(r.get("meeting_name"), r.get("date_utc"))
...
def get_f1_standings(drivers: bool = True, year: int = None) -> list:
    """
    A OpenF1 não fornece standings diretamente.
    Por enquanto, retornamos o calendário como fallback.
    """
